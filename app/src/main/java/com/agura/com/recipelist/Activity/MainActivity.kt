...
import com.agura.com.recipelist.data.CustomAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recipe.add(Recipe(
                ...
                "This sandwich is stunningly delicious and tastes as good as it is healthy. Any greens of choice will work." +
        ...
        recipe.add(Recipe(
                R.drawable.mango,
                "Mango-Line Bean Salad",
                "Everyone loves this, so double or even triple the recipe! It vanishes in a flash, and also works well as a salsa. It really is our all-time favorite summer salad.",
        ...
        recipe.add(Recipe(
                ...
                "This soup is so good Essy and I ate it ALL the first time I made it. If someone is hesitant about plant-based food this has to be convincer.",
        ...
        recipe.add(Recipe(
                R.drawable.lime,
                "Lime Mousse",
                "This is FABULOUS alone, topped with fruit of any kind of as a frosting on cake. It is fast to make at the last minute. Use more or less lime according to taste.",
        ...
        val adapter = CustomAdapter(recipe)
